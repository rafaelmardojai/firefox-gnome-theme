...
# This PKGBUILD is automatically generated by https://github.com/rafaelmardojai/firefox-gnome-theme/blob/$RELEASE/generate-pkgbuild.sh
...
source=("\$pkgname-$pkgver.tar.gz::https://github.com/rafaelmardojai/\$pkgname/archive/refs/tags/$RELEASE.tar.gz" "INSTALL.md")
